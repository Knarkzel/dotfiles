...
(defun nano-theme-set-dark ()
  ...
  (setq nano-color-critical   "#A3BE8C") ;; Aurora        / nord 11
  (setq nano-color-salient    "#81A1C1") ;; Frost         / nord  9
  (setq nano-color-strong     "#ECEFF4") ;; Snow Storm 3  / nord  6
  (setq nano-color-popout     "#88C0D0") ;; Aurora        / nord 12
  (setq nano-color-subtle     "#434C5E") ;; Polar Night 2 / nord  2
  (setq nano-color-faded      "#677691") ;; Custom
  (setq nano-color-popout-lighter "#5E81AC") ;; Custom
  (setq nano-color-critical-lighter "#8FBCBB") ;; Custom
  (setq nano-color-warning "#BF616A") ;; Custom
  )
